...
class ResNetFus(BaseModule):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNetFus, self).__init__(init_cfg)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNetFus, self).train(mode)
        self._freeze_stages()
...
class ResNetV1dd(ResNetFus):
    ...
    def __init__(self, **kwargs):
        super(ResNetV1dd, self).__init__(
